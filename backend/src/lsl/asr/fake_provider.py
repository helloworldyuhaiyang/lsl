...
class FakeAsrProvider:
    """
    本地固定返回的 ASR Provider。
    - submit: 返回任务引用
    - query: 固定返回 succeeded + 本地 result.json
    """
    ...
    @staticmethod
    def _extract_duration_ms(payload: dict) -> int | None:
    ...
    @staticmethod
    def _extract_utterances(payload: dict) -> list[AsrUtterance]:
