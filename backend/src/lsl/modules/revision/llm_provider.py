...
5. Include one short Chinese delivery cue in the rewritten script when helpful.
...
- suggested_text should be a single editable script string. If you include a delivery cue, put it at the front in square brackets, such as "[用轻松自然的语气开口] What did you do last weekend?"
...
Output schema:
{
  "items": [
    {
      "source_seqs": [1],
      "suggested_text": "[有点好奇地、轻松自然地开口] What did you do last weekend?",
      "score": 88,
        ...
        for item in req.utterances:
            suggestions.append(
                RevisionSuggestion(
                    ...
                    suggested_text="[用夸张又兴奋的语气读这句] This is a fake revised sentence for debugging.",
                    score=78,
                    issue_tags="调试文案",
