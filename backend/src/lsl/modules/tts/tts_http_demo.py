...
# -------------客户需要填写的参数----------------
appID = "4665014662"
accessKey = "_cRwa6onbKTwxVN146tVYTxME4F4AaP4"
resourceID = "seed-tts-2.0"
speaker = "zh_female_vv_uranus_bigtts"
text = "Yeah, there are a lot of things you want to get done, but your time is limited because you need to focus more on your work, right? Your job comes first."
additions = { 
                "explicit_language": "en", # 匹配英文文本
